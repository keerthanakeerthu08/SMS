...
export default class Exam extends Component {
  ...
  async init(props, isPageLoading = false) {
    ...
    if (state) await this.dataSet(state);
    await this.setState({ data: state || this.dataGet() });
  ...
  dataGet = () => {
    let getData = localStorage.getItem("sessionData"); 
              ...
              {!isPageLoading && !isLoading &&
                <Fragment>
                  <Breadcrumb>
                    ...
                    {(form === "viewQuestions") && <BreadcrumbItem><NavLink to="/exam/section" title="Exam Id">Section</NavLink></BreadcrumbItem>}
                    <BreadcrumbItem active>{(_form === 'offlineExam' && "Offline Exam") || (_form === 'onlineExam' && "Online Exam") || _form}</BreadcrumbItem>
                  </Breadcrumb>
                  {(form === "onlineExam" || form === "offlineExam") ?
                    <Container fluid>
                      ...
                      <div className="d-md-flex align-items-md-center justify-content-md-between">
                        <h5 className="pg-title">{(_form === 'offlineExam' && "Offline Exam") || (_form === 'onlineExam' && "Online Exam") || _form}</h5>
