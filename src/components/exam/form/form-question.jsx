...
export default class QuestionForm extends Component {
  ...
  schema = {
    ...
    noquestion: Joi.any().optional().label("No Question"),
    sectionId: Joi.string().required().label("Section Id"),
    question: Joi.string().required().label("Question"),
    answer: Joi.string().required().label("Answer"),
    optionA: Joi.string().required().label("option A"),
    optionB: Joi.string().required().label("option B"),
    optionC: Joi.string().required().label("option C"),
    optionD: Joi.string().required().label("option D"),
  }
    ...
    return (
      <Fragment>
        <Breadcrumb>
          ...
          <BreadcrumbItem > <NavLink to="/exam/section">Section</NavLink></BreadcrumbItem>
          <BreadcrumbItem > <NavLink to="/exam/viewQuestions">Question</NavLink></BreadcrumbItem>
                ...
                {formState.values.questions && formState.values.questions.map((question, i) =>
                  <Scope scope={`questions[${i}]`} key={i}>
                    <Row>
                      ...
                      <Col sm={12} md={12}>
                        <Textarea
                          field="question"  maxlength="500" label={`Question ${i + 1} *`} name="Question 1"
                    ...
                    <Row>
                      <Col sm={12} md={12}>
                        <Textarea
                          field="answer" label="answer *" name="Answer"  maxlength="500"  helper="Enter the answer as option A or B" 
