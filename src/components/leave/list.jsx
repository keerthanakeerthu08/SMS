  ...
  actionsFormatter = (cell, row, rowIndex, formatExtraData) => {
    ...
    if (userType !== 'student' && userType !== 'parent') {
      rightsData && rightsData[_form] && rightsData[_form].edit.value && row.status === 'request' &&
        links.push(<div  onClick={() => confirm("Are you sure? You want to Continue.", () => this.updateLeave(row, 'Approved'))}  className='badge badge-success' style={{ cursor: 'pointer' }}>Approve</div>)
      rightsData && rightsData[_form] && rightsData[_form].edit.value && row.status === 'request' &&
        links.push(<div  onClick={() => confirm("Are you sure? You want to Continue.", () => this.updateLeave(row, 'Rejected'))} className='badge badge-danger' style={{ cursor: 'pointer' }}>Reject</div>)
    }
    if (userType === 'student' && row.status === 'request' ) {
      links.push(<div  onClick={() => confirm("Are you sure? You want to Continue.", () => this.updateLeave(row, 'Cancelled'))} className='badge badge-danger' style={{ cursor: 'pointer' }}>Cancel</div>)
    }
