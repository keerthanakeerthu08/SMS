...
export default class Timetable extends Component {
  ...
  actionsFormatter = (cell, row, rowIndex, formatExtraData) => {
    ...
    links.push(<div onClick={() => confirm("Are you sure? You want to delete this", () => this.deleteFun(row))} className='badge badge-danger'>Delete</div>)
        ...
        {!isPageLoading && <React.Fragment>
          {!isLoading &&
            <div id="divToPrint">
              ...
              {data && data[0] && data[0].examName && <h6>
                {data[0].examName}
              </h6>
              }
              <BootstrapTable
