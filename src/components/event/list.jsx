...
export default class EventList extends Component {
    ...
    getColumnHeaders(eventformType, prefixUrl = "") { //dynamic headers        
        ...
        if (userType === 'student') {
            excludeKeys.unshift("Student Name");
            excludeKeys.unshift("actions");
        }
        ...
        let def = {
            ...
            "Fee": { dataField: 'fee', text: 'Fee', sort: true },
    ...
    actionsFormatter = (cell, row, rowIndex, formatExtraData) => {
        ...
        rightsData && rightsData[_form] && rightsData[_form].delete.value && row.status === 'active' &&
            links.push(<div onClick={() => confirm("Are you sure? You want to delete this", () => this.deleteAttendees(row))} className='badge badge-danger'>Delete</div>)
        rightsData && rightsData[_form] && rightsData[_form].delete.value && row.status !== 'active' &&
            links.push(<div onClick={() => confirm("Are you sure? You want to unblock this", () => this.deleteAttendees(row))} className='badge badge-danger'>UnBlock</div>)
