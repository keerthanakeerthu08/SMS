...
import { passwordUpdate, passwordValidate } from 'services/authService';
  ...
  render() {
    ...
    switch (userType) {
      case "sadmin":
        ...
        logoUrl = session && session.data && session.data.pictureUrl
        break;
      case "client":
      ...
      case "entity":
        ...
        break;
      default:
        name = session && session.data && (session.data.entityName || session.data.entity);
        logoUrl = session && session.data && session.data.entityLogo;
        break;
    }
        ...
        <Navbar expand="md" className="bg-white nav-eco" >
          ...
          <Collapse isOpen={false} navbar>
            <Nav className="ml-auto" navbar>
              <NavItem>
                <NavLink href="/home"> <FAIcons.FaHome /></NavLink>
              </NavItem>
              <NavItem>
              ...
              {session && session.uid &&
                <UncontrolledDropdown nav inNavbar>
                  ...
                  <DropdownMenu right>
                    ...
                    <DropdownItem divider />
                    <Link to="/">
                      <DropdownItem onClick={(e) => { localStorage.clear(); sessionStorage.clear(); }}>
                        Logout
                    </DropdownItem>
                    </Link>
                  </DropdownMenu>
