...
export default class RolesForm extends Component {
  ...
  helper = {
    RoleName:<Fragment><b>Ex:</b> staff or HOD or student </Fragment>,
  }
    ...
    return (
      <Fragment>
            ...
            <div>
              ...
              <section>
                ...
                <Row>
                  ...
                  <Col sm={12} md={3}>
                    <Input field="type" label="Enter Role Name*" name="type" onChange={this.handleChange} readOnly={readOnly} helper={this.helper.RoleName}/>
                  </Col>
        ...
        <div className="text-right">
          <button type="button" className="btn btn-primary btn-sm" onClick={() => props.history.goBack()}>Cancel</button>
          <button type="submit"  onClick={() => confirm("Are you sure? You want to block this user.", (e) => this.onSubmit(e))}  className="btn btn-primary btn-sm">Submit</button>
        </div>
      </Fragment>
    );
  }
