...
export default class ReportList extends Component {
    ...
    async getColumnHeaders(type, prefixUrl = "") {
        ...
        let def = {
            ...
            "createdDate": { dataField: 'createdDate', text: 'Submission Date', sort: true },
        }
        switch (type) {
            case "attendance":
                const { formdata: { month, year } } = this.props;
                ...
                <div id="divToPrint">
                    {
                        ...
                        <BootstrapTable
                            ...
                            classes="table table-bordered table-hover table-sm attendancetable"
