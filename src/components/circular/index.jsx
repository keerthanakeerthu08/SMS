...
export default class CircularDataList extends React.Component {
  ...
  addNavigation(form) {
    return <NavLink className="btn btn-primary btn-sm" to={`/notification/add/circular`}>+ Add Circular </NavLink>
  }
      ...
      <Fragment>
        <Container fluid>
          <div className="d-md-flex align-items-md-center justify-content-md-between">
            <h5 className="pg-title"> Circular</h5>
            <div >
              {this.addNavigation()}
            </div>
