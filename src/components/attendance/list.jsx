...
export default class AttendanceList extends Component {
  ...
  actionsFormatter = (cell, row, rowIndex, formatExtraData) => {
    ...
    rightsData && rightsData[_form] && rightsData[_form].delete.value && attendanceType === 'holiday' &&
      ...
      links.push(<div style={{ cursor: 'pointer' }} onClick={() => confirm("Are you sure? You want to delete this", () => this.deleteRow(row))} className='badge badge-danger'>Delete</div>)
