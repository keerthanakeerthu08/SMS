...
export default class AddAttendance extends Component {
    constructor(props) {
        ...
        this.state = {
            uid: '',
            data: { department: '', batch: '', client: '', entity: '', branch: '', homeworks: '', subject: '' },
                        ...
                        <div>
                            <section>
                                ...
                                <Row>
                                    ...
                                    <Col sm={6} md={3}>
                                        <CustomSelect field="subject" label="Subject Name*" name="subject" getOptionValue={option => option.code} getOptionLabel={option => option.name} options={this.state.allSubjects} validateOnBlur validate={e => this.validateProperty('subject', e)} onChange={this.handleChange} />

                                    </Col>
                                    <Col sm={6} md={3}>
                                        <Input
                                            field="period" label="Period*" name="period" validate={e => this.validateProperty('period', e)} helper="Ex: 1 or 2" />
                                    </Col>
