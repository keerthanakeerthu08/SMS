...
export default class Attendance extends Component {
  ...
  renderAttendanceForm(attendanceType, data, client, entity, branch, department, batch) {//Pass the datas to the Attendance List
    ...
    return <AttendanceList
      ...
      data={data} props={this.props} details={details} rightsData={rightsData} refreshTable={this.holidayList} userType={userType}
    />
  }
                    ...
                    <div className="d-md-flex align-items-md-center justify-content-md-between">
                      ...
                      <div  >
                        {rightsData && rightsData[_form] && rightsData[_form].create.value &&
                          <NavLink className="btn btn-primary btn-sm" to={`add/${attendanceType}`}>+ Add {attendanceType} </NavLink>
                        }
                      </div>
                    </div>
