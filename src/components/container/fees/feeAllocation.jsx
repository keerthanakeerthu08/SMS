  ...
  render() {
    return (
      <Container fluid><br />
        ...
        <Row>
          <Col sm="3">
            <TabsItem icon={<FAIcons.FaHourglassHalf />} text="Fee Allocation" active={true} to="/main/fee_allocation" />
          </Col>
          <Col sm="3">
            <TabsItem icon={<FAIcons.FaUserClock />} text="Fee Collection" to="/main/fee_collection" />
          </Col>
        </Row>
