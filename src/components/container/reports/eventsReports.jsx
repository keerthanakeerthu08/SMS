    ...
    return (
      <div>
        <Container fluid>
          ...
          <Row>
            <Col sm="2">
              <TabsItem icon={<FAIcons.FaRegChartBar />} text="Attendance" to="/main/attendance_reports" />
            </Col>
            <Col sm="2">
              <TabsItem icon={<FAIcons.FaClipboardList />} text="Exam" to="/main/exam_reports" />
            </Col>
            <Col sm="2">
              <TabsItem icon={<FAIcons.FaBook />} text="Assignment" to="/main/assignment_reports" />
            </Col>
            <Col sm="2">
              <TabsItem icon={<FAIcons.FaFileInvoiceDollar />} text="Fee Details" to="/main/fee_reports" />
            </Col>
            <Col sm="2">
              <TabsItem icon={<FAIcons.FaTasks />} active={true} text="Events" to="/main/event_reports" />
            </Col>
          </Row>
          <br />
