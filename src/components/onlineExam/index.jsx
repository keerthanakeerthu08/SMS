  ...
  render() {
    ...
    return (
      <Fragment >
        ...
        {this.state.result ?
          null :
          <div className="onlineExamTimer"><div><div><p>{time.s}</p> <p className="smalltxt">Seconds</p>   </div><div><p>{time.m} : </p> <p className="smalltxt">Minutes</p> </div> <div><p>{time.h} :</p> <p className="smalltxt">Hours</p></div>  </div></div>
        }
