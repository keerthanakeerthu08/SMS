...
export default class Result extends Component {
    ...
    renderResultTable(type, data = []) {
        return <ExamResult type={type} data={data} props={this.props} userType={type} />
    }
    setFormApi = (formApi) => {
    ...
    onSubmit = async () => {
        ...
        try {
            let resultTableData = await this.getResultList(params, userType, uid, studentId)
            await this.setState({
                resultTableData,
                resultTable: true
            })
            this.renderResultTable(userType, resultTableData)
        } catch{
            this.handleError()
        }
    }
    ...
    render() {
        ...
        const { isPageLoading, isLoading,  clientIds, entityIds, branchIds, departmentIds, batchIds, examname, type, isClient, isEntity, isBranch, isDepartment, isBatch, resultTableData } = this.state;
                            ...
                            <Fragment>
                                <Container fluid>
                                    ...
                                    {this.state.resultTable &&
                                        this.renderResultTable(type, resultTableData)
                                    }
                                </Container>
                            </Fragment>
                        }
