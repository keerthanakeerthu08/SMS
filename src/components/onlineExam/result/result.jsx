...
export default class ClientList extends Component {
    ...
    getColumnHeaders(type, prefixUrl = "", dynamicLabels = {}) {
        let userType = this.props.props.session.data.userType;
        let allKeys = ["name", "uid", "examName", "examId", "marks", "remarks", "totalmarks"]
        let excludeKeys = ["examId"];
        if(userType === 'student'){
        ...
        let def = {
            ...
            "remarks": { dataField: 'remarks', text: `Remarks`, sort: true ,formatter: this.remarkFormatter},
    ...
    remarkFormatter(cell, row, rowIndex, formatExtraData){
        if(row.remarks === "Low Marks") {
        return  <div       
