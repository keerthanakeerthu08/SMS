...
export default class AddGeneralSettings extends Component {
  ...
  render() {
    const { action, formType, props } = this.props;
    return (
      <Fragment>
          ...
          {({ formApi, formState }) => (
            <div>
              <section>
                <Row>
                  <Col sm={6} md={3}>
                    <Input field="code" readOnly={action === 'edit'} label=" Code*" name="code" validate={e => this.validateProperty('code', e)} helper={_.upperFirst(formType)+" Code"}/>
                  </Col>
                  {
                  ...
                  <Col sm={6} md={3}>
                    <Input field="name" label="Name*" name="name" validate={e => this.validateProperty('name', e)}  helper={_.upperFirst(formType)+" Name"}/>
                  </Col>
