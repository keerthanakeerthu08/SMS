  ...
  addNavigation() {
    ...
    switch (form) {
      ...
      case "assessmentWeitage":
        return <NavLink className="btn btn-primary btn-sm" to={`/grade/add/assessmentweitage`}>+ Add Assessment Weightage</NavLink>;
      case "skills":
        return <NavLink className="btn btn-primary btn-sm" to={`/grade/add/skill`}>+ Add CCE Skill</NavLink>;
      case "subjectWeitage":
        return <NavLink className="btn btn-primary btn-sm" to={`/grade/add/subjectweitage`}>+ Add Subject Weightage</NavLink>;
      default:
        return <NavLink className="btn btn-primary btn-sm" to={`/grade/add/gradeform`}>+ Add Grade</NavLink>;
    }
  }
              ...
              {!isPageLoading && !isLoading &&
                <Fragment>
                  <Breadcrumb>
                    ...
                    <BreadcrumbItem><NavLink to="/grade/grade">Grade Settings</NavLink></BreadcrumbItem>
                    <BreadcrumbItem active> {(listType === "assessmentWeitage" && "Assessment Weightage") || (listType === "subjectWeitage" && "Subject Weightage") || listType}</BreadcrumbItem>
                  ...
                  <Container fluid>
                    ...
                    <div className="d-md-flex align-items-md-center justify-content-md-between">
                      <h5 className="pg-title">{(_form === 'AssessmentWeitage' && "Assessment Weitage") || (_form === 'SubjectWeitage' && "Subject Weitage") || _form}</h5>
                      <div  >
                    ...
                    {(listType === 'subjectWeitage' || isBranch) &&
                          ...
                          <div>
                            <section>
                              <Row>
                                ...
                                {listType === 'subjectWeitage' && isDepartment && <Col sm={12} md={3}>
