      ...
      <Fragment>
        <Container fluid>
          <Breadcrumb>
            ...
            <BreadcrumbItem><NavLink to="/grade/skills">Skills</NavLink></BreadcrumbItem>
              ...
              <div>
                ...
                <section>
                  <Row>
                    ...
                    <Col sm={6} md={6}>
                      <Input field="assessmentArea" label="CCE Skills Name *" helper="Ex:Writing Skills, Reading Skills" validateOnBlur validate={e => this.validateProperty('assessmentArea', e)} readOnly={formActionType} />
                    </Col>
                  </Row>
                </section>
                {!formActionType &&
