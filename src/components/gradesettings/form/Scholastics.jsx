...
export default class Scholastics extends Component {
  ...
  schema = {
    ...
    weightage: Joi.number().required().label("Weightage")
  };
              ...
              <div>
                ...
                <section>
                  <Row>
                    ...
                    <Col sm={6} md={3}>
                      <Input field="mode" label="Assessment Name *" validateOnBlur validate={e => this.validateProperty('mode', e)} readOnly={formActionType} helper="Ex: Formative Assessment" />
                    </Col>
                    <Col sm={6} md={3}>
                      <Input field="weightage" label="Weightage(in %) *" validateOnBlur validate={e => this.validateProperty('weightage', e)} readOnly={formActionType} helper="Ex: 30 or 40" />
                    </Col>
                  </Row>
                </section>
                {!formActionType &&
