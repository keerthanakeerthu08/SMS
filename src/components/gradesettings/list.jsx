...
export default class GradeList extends Component {
  ...
  actionFormater = (cell, row, rowIndex, formatExtraData) => {
    ...
    rightsData && rightsData[_form] && rightsData[_form].delete.value &&
      links.push(<div onClick={() => confirm("Are you sure? You want to delete this", () => this.gradeDelete(row))} className='badge badge-danger'>Delete</div>)
  ...
  sActionFormater = (cell, row, rowIndex, formatExtraData) => {
    ...
    rightsData && rightsData[_form] && rightsData[_form].delete.value &&
      links.push(<div onClick={() => confirm("Are you sure? You want to delete this", () => this.scholasticsDelete(row))} className='badge badge-danger'>Delete</div>)
    return <div className="actions">{links.concat(" ")}</div>
  }
  ...
  skillActionFormater = (cell, row, rowIndex, formatExtraData) => {
    ...
    rightsData && rightsData[_form] && rightsData[_form].delete.value &&
      links.push(<div onClick={() => confirm("Are you sure? You want to delete this", () => this.cceSkillDelete(row))} className='badge badge-danger'>Delete</div>)
    return <div className="actions">{links.concat(" ")}</div>
  }
  ...
  creditActionFormater = (cell, row, rowIndex, formatExtraData) => {
    ...
    rightsData && rightsData[_form] && rightsData[_form].delete.value &&
      links.push(<div onClick={() => confirm("Are you sure? You want to delete this", () => this.subjectWeitageDelete(row))} className='badge badge-danger'>Delete</div>)
    return <div className="actions">{links.concat(" ")}</div>
  }
