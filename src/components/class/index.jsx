                            ...
                            <Fragment>
                                <Breadcrumb>
                                    ...
                                    <BreadcrumbItem active>
                                        {formTypes === 'class' &&
                                            <NavLink to={`/timetable/add/class`}>Class TimeTable</NavLink>
                                        }
                                        {formTypes === 'rescheduletable' &&
                                            <NavLink to={`/classList/reschedule`}>ReSchedule TimeTable</NavLink>
                                        }
                                    </BreadcrumbItem>
                                </Breadcrumb>
                                ...
                                <Container fluid>
                                    <div className="mb-4 subnav-div">
                                        {formTypeOrder.map((formTypes) =>
                                            <NavLink key={formTypes} onClick={this.redirectTo} to={{ pathname: `/classLists/${formTypes}`, query: this.props.location.query }} className={classNames('subnav')} activeClassName="subnav-active" exact={true} >{formTypeKeys[formTypes]['label']}</NavLink>
                                        )}
                                    </div>
                                    <div className="d-md-flex align-items-md-center justify-content-md-between">
                                        <h5 className="pg-title">{(formTypes === 'class' && "Class TimeTable") || (formTypes === 'rescheduletable' && "ReSchedule TimeTable") || formTypes}</h5>
                                        {formTypes === 'class' &&
