...
export default class TimeTableForm extends Component {
    state = {
        data: {
            client: "", entity: "", branch: "", department: "", batch: "", category: "Class"
        },
    ...
    helper = {
        title: <Fragment><b>Ex:</b> Class Timetable </Fragment>,
        days: <Fragment>No of Working Days. <b>Ex:</b> 5 or 6 </Fragment>,
    }
    ...
    formStateCheck = async (data) => { //Get Datas for edit 
        ...
        data.department = data.clients[0].departmentId || data.clients[0].department;
                    ...
                    {({ formApi, formState }) => (
                        <div>
                                    ...
                                    {actiontype === 'add' &&
                                        < Col sm={12} md={3}>
                                            <Input
                                                ...
                                                validate={e => this.validateProperty('title', e)} disabled={disabled} helper={this.helper.title}
                                            />
                                        </Col>}
                            ...
                            <section>
                                ...
                                <Row>
                                    <Col sm={12} md={4}>
                                        <CustomSelect field="category" label="Category *" name="category" getOptionValue={option => option.id} getOptionLabel={option => option.name} options={this.state.category} validateOnBlur validate={e => this.validateProperty('category', e)} disabled={disabled} />
                                    </Col>
                                    <Col sm={12} md={4}>
                                        <Input
                                            field="days" label="Days*" name="days"
                                            validate={e => this.validateProperty('days', e)} disabled={disabled} helper={this.helper.days}
                                        />
                                    </Col>
                                    <Col sm={12} md={4}>
                                        <CustomSelect field="classteacher" label="Class Teacher*"
                                            name="classteacher" getOptionValue={option => option.name} getOptionLabel={option => option.name} options={staffList} validateOnBlur validate={e => this.validateProperty('classteacher', e)} onChange={this.handleChange} disabled={disabled} />
                                    </Col>
                                </Row>
