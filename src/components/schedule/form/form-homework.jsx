...
export default class HomeworkForm extends Component {
    ...
    render() {
        ...
        const { props, actiontype } = this.props;
        let disabled = false;
                        ...
                        <div>
                            ...
                            <section>
                                ...
                                <Row>
                                    ...
                                    <Col sm={12} md={4}>
                                        <CustomSelect field="subjectId" label="Subject*" name="subjectId" getOptionValue={option => option.code} getOptionLabel={option => option.name} options={this.state.allSubjects} validateOnBlur validate={e => this.validateProperty('subjectId', e)} onChange={this.handleChange} disabled={disabled} />
                                    </Col>
                                </Row><br />

                                <Row>
                                    <Col sm="12" md="12">
                                        <Textarea field="description" label="Description" name="description" validateOnBlur validate={e => this.validateProperty('description', e)} disabled={disabled} />
                                    </Col>
                                </Row>
