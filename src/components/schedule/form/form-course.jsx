            ...
            <div>
                  ...
                  }
                  {
                    ...
                    <Col sm={12} md={3}>
                      <Input
                        ...
                        validate={e => this.validateProperty('code', e)}  disabled={disabled}
                      />
                    </Col>
                  }
                  <Col sm={12} md={3}>
                    <Input
                      field="title" label="Title*" name="title" helper="Course Title" 
              ...
              <section>
                <Row>
                  <Col sm={6} md={3}>
                    <Input
                      field="bannerimageurl" label="BannerImageURL" name="bannerimage"  disabled={disabled}
                    />
                  </Col>
                  (OR)
                  <Col sm={6} md={3}>
                    <Input
                      ...
                      onChange={this.handleChangeFile} disabled={disabled}
                    />
                  </Col>
                </Row>
              </section>
