...
export default class AttendanceForm extends Component {
  ...
  helper={
    title:<Fragment>Attendance Title. <b>Ex:</b> Daily Attendance</Fragment>
}
              ...
              <section>
                ...
                <Col sm={12} md={3}>
                  <Input
                    ...
                    validate={e => this.validateProperty('noOfTimesTaken', e)} disabled={disabled} helper="Number of times to take Attendance"
                  />
                </Col>
              </section>
              {!disabled &&
