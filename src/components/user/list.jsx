      ...
      rightsData &&
        ...
        ? links.push(
          <div
            ...
            onClick={() => confirm("Are you sure? You want to block this user.", () => this.deleteUserbyId(row, 'block'))}
        ...
        : links.push(
          <div
          onClick={() => confirm("Are you sure? You want to unblock this user.", () => this.deleteUserbyId(row, 'active'))}
