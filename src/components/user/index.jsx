...
export default class UserRoot extends Component {
  ...
  checkLoggedIn = async () => {
    ...
    const { userType, userLevel, client, entity, branch, department, batch, uid, code } = sessionData;
    if (userType === 'staff')
    ...
    await this.setState({
      type: type,
      client: userType === "client" ? code : client,
      entity: userType === "entity" ? code : entity,
