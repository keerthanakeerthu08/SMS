...
export default class OrganizationForm extends Component {
  ...
  schema = {
    role: Joi.string().required().label("Designation"),
              ...
              <section>
                ...
                <Row>
                  ...
                  <Col sm={12} md={3}>
                    ...
                    <SDP isOutsideRange={isOutsideRange} field="joiningDate" label="Joining Date*" id="joiningDate" date={joiningDate} validate={e => this.validateProperty('joiningDate', e)} onChange={this.dateValue}   numberOfMonths={1}></SDP>
                  </Col>
