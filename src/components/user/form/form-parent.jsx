...
export default class ParentForm extends Component {
    ...
    schema = {
        ...
        contactNo: Joi.string().regex(/^\+[1-9]{1}[0-9]{3,14}$/).required().label("Contact Number"),
    ...
    helper = {
        contactNo: <Fragment>Contact Number(International Format) for communication. <b>Eg.</b><i><strong>+919090909090</strong></i></Fragment>
    }
                                            ...
                                            <Row>
                                                ...
                                                <Col sm={12} md={4}>
                                                    <Input field="contactNo" label="Contact Number*"
                                                        validateOnBlur validate={e => this.validateProperty('contactNo', e)}  helper={this.helper.contactNo}/>
                                                </Col>
                                                {
