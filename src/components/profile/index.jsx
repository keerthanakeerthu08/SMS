...
export default class Profile extends Component {
  ...
  getSampleData = async () => {
    ...
    if (userdata.userType === "client" || userdata.userType === "entity") userdata["roles"] = userdata.userType
    ...
    if (primary !== '' || secondary !== '') {
      ...
      primaryaddress = primaryaddress.replace(",,", ",")
      ...
      secondaryaddress = secondaryaddress.replace(",,", ",")
      userdata.communication[0] = { primaryaddress, secondaryaddress }
    }
    return userdata
  }
                      ...
                      <div className="page-user">
                        ...
                        <section>
                          ...
                          <Row>
                            ...
                            <Col sm={6} md={3}>
                              <Input
                                field="roles" label="Role" name="roles" readOnly
                              />
                            </Col>
                          </Row>
                        </section>
